<x-layouts.app>
    <div class="flex flex-col mb-4">
        <span class="text-xl font-semibold my-2 sm:text-2xl whitespace-nowrap dark:text-white">Заощадження
        </span>
        @if (session('success'))
            <x-messages.success />
                            ...
                            <li class="py-3 sm:py-4">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div
                                        ...
                                        <span style="background-color: {{ $saving->currency->code->getCodeColor() }}"
                                            class="text-xs font-medium px-2.5 py-0.5 ml-1 rounded dark:text-[#312C3A]">
                                            {{ $saving->currency->code->value }}
                                        </span>
                                    </div>
                                </div>
