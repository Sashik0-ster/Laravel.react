<x-layouts.app>
    ...
    <span class="self-center text-xl font-semibold my-2 sm:text-2xl whitespace-nowrap dark:text-white">Dashboard</span>
                    ...
                    @foreach($fields as $name => $label)
                        <div>
                            ...
                            <x-forms.auth.input-text
                                id="{{ $name }}"
                                name="{{ $name }}"
                                placeholder="Введіть {{ mb_strtolower($label) }}"
                                required/>
                        </div>
                    @endforeach
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                ...
                                <div class="text-sm font-normal text-gray-500 dark:text-gray-400">1</div>
                            </td>
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">1
                            </td>
