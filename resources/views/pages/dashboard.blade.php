<x-layouts.app>
    ...
    <div class="flex flex-col mb-4">
        <span class="text-xl font-semibold my-2 sm:text-2xl whitespace-nowrap dark:text-white">Дашборд
    ...
    <div id="drawer-create-product-default"
        ...
        <h5 id="drawer-label"
            class="inline-flex items-center mb-6 text-sm font-semibold text-gray-500 uppercase dark:text-gray-400">Тест
            форми</h5>
        <button type="button" data-drawer-dismiss="drawer-create-product-default"
            ...
            <span class="sr-only">Замкнути</span>
        </button>

        <x-forms.form-component type="{{ \App\Models\Income::class }}" action="{{ route('pages.income') }}"
            method="GET">

            <x-forms.auth.input-label for="login">
                Login
            </x-forms.auth.input-label>
            <x-forms.auth.input-text name="password" id="password" type="number" />

            <x-forms.auth.input-label for="password">
                Password
            </x-forms.auth.input-label>
            <x-forms.auth.input-text name="password" id="password" type="password" />

            <x-forms.auth.input-label for="email">
                Email
            </x-forms.auth.input-label>
            <x-forms.auth.input-text name="email" id="email" type="email" />
            <div>
            ...
            <div
                ...
                <div class="flex space-x-4">
                    ...
                    <x-forms.auth.close-form-button type="button">
                        Закрити
                    </x-forms.auth.close-form-button>

                </div>
            </div>

        </x-forms.form-component>
    </div>
