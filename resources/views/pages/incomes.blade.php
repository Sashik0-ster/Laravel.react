<x-layouts.app>
    <div class="flex flex-col">
        <div class="flex flex-wrap items-center w-full justify-between mb-2">
            <span class="text-xl font-semibold my-2 sm:text-2xl whitespace-nowrap dark:text-white">Доходи</span>
    ...
    <div id="drawer-create-product-default"
     ...
     bg-white dark:bg-gray-800"
        ...
        <div class="relative bg-white rounded-lg dark:bg-gray-800 min-h-screen md:min-h-0">
            ...
            <x-forms.auth.form action="{{ route('income.create') }}" method="POST">
                <div class="relative max-h-screen pb-25">
                    ...
                    <x-forms.auth.input-text type="date" name="income_date" id="income_date" />
    ...
    <x-tables.incomes-table :incomes="$incomes" :accounts="$accounts" :currencies="$currencies" :sources="$sources" :categories="$categories" />
