<x-layouts.app>
    ...
    <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Доходи</span>
    ...
    <x-forms.product-forms.add-product-form
    />
                    ...
                    <div class="overflow-hidden shadow sm:rounded-lg">
                      ...
                      <span
                          class="bg-red-100 text-red-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md border border-red-100 dark:border-red-400 dark:bg-gray-700 dark:text-red-400">Cancelled</span>
                            ...
                            <tr>
                                <td class="p-4 text-sm font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                    Payment from <span class="font-semibold">Jes Leos</span>
                                </td>
                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                    Apr 15 ,2021
                                </td>
